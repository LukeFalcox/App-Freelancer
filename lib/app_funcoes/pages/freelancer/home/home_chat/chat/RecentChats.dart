...
class _RecentchatsState extends State<Recentchats> {
  ...
  future: widget.freeorcli 
      ? _authService.getcontactsfreelancers(email) 
      : _authService.getcontactsclient(email),
  builder: (context, snapshot) {
    ...
    return Flexible(  // Aqui usamos Flexible para lidar com o espaço disponível
      child: ListView(
        children: snapshot.data!
            .map<Widget>((chatRoomId) => _buildUserListItem(chatRoomId, email))
            .toList(),
      ),
    );
  },
      ...
      builder: (context, snapshot) {
        ...
        return Column(
          children: snapshot.data!.docs.map<Widget>((userDoc) {
            ...
            String? targetEmail =
                widget.freeorcli ? userData['cliente'] : userData['freelancer'];
            String? uid =
                widget.freeorcli ? userData['uidcli'] : userData['uidfree'];
                            ...
                            StreamBuilder<QuerySnapshot>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                if (snapshot.hasData  &&
                                  ...
                                  if (messagesdata['formattedTime'] != null) {
