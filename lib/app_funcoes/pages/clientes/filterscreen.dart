...
import 'package:app_freelancer/app_funcoes/pages/configs/auth_service.dart'; // Importando AuthService
                ...
                child: PageView(
                  ...
                  children: [
                    Constructorcards(
                      ...
                      area: "administration",
                      tit: "Administração",
                      destinationWidget: Budget(area: 'administration', authService: widget.authService,userEmail: widget.userEmail), 
                    ),
                    Constructorcards(
                      image: "image/img/administration.png",
                      email: widget.userEmail, // Passando o email do usuário
                      ...
                      destinationWidget: Budget(area: 'ti',authService: widget.authService,userEmail: widget.userEmail), 
                    ),
                    Constructorcards(
                      ...
                      area: "engineering",
                      tit: "Engenharia",
                      destinationWidget: Budget(area: 'engineering',authService: widget.authService,userEmail: widget.userEmail), 
                    ),
                  ],
                ),
              ),
